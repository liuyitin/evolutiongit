                    ...
                    <el-menu :default-openeds="$route.path" :unique-opened="true" router>
                        <div class="user-panel">
                            ...
                            <div class="info disnone">
                                <p>263041STA</p>
                                <div>
                                    <img src="~@/assets/img/bf1.png" alt="">
                                    <span>Admin</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <el-menu-item-group>
                            ...
                            <el-menu-item index="/layout/sub">
                                <div class="menu-item-img">
                                    <img src="~@/assets/img/bf2.png" alt="">
                                </div>
                        ...
                        <el-menu-item-group>
                            ...
                            <el-menu-item index="5">
                                <div class="menu-item-img">
                                    <img src="~@/assets/img/bf6.png" alt="">
                                </div>
                        ...
                        <el-menu-item-group>
                            ...
                            <el-menu-item index="6">
                                <div class="menu-item-img">
                                    <img src="~@/assets/img/bf7.png" alt="">
                                </div>
                                <span slot="title" class="disnone">Win Loss Report</span>
                            </el-menu-item>
                            <el-menu-item index="7">
                                <div class="menu-item-img">
                                    <img src="~@/assets/img/bf8.png" alt="">
                                </div>
                        ...
                        <el-menu-item-group>
                            ...
                            <el-submenu index="10">
                                <template slot="title">
                                    <div class="menu-item-img">
                                        <img src="~@/assets/img/bf9.png" alt="">
